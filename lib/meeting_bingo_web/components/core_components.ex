defmodule MeetingBingoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MeetingBingoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MeetingBingoWeb.Gettext, "errors", msg, opts)
    end
  end
